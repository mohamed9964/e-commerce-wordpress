...
<div class="yith-wcbep-how-to yith-plugin-fw-panel-custom-tab-container">
	<div class="yith-wcbep-how-to-content">
		<p>
			<?php echo sprintf( __( 'This page of the documentation is a guide for the usage of the free version of the %sYITH WooCommerce Product Bundles%s plugin.', 'yith-woocommerce-product-bundles' ), '<strong>', '</strong>' ) ?>
			<br/>
			<?php _e( 'Now we analyze the necessary steps for the cretion of a product bundle, and its possible options.', 'yith-woocommerce-product-bundles' ) ?>
			<br/>
			<br/>
		...
		<p>
			<?php echo sprintf( __( 'Now configure the options clickin on the new tab "%1$sBundled Options%2$s" that has been added to the "%1$sProduct Data%2$s" section of the product.', 'yith-woocommerce-product-bundles' ), '<strong>', '</strong>' ) ?>
		</p>
		...
		<p class="yith-wcbep-how-to__message"><?php _e( 'The plugin lets you add only simple products.', 'yith-woocommerce-product-bundles' ) ?></p>
		<p>
		...
		<p>
			<?php echo sprintf( __( 'Now you just have to set the price, the description and the image of your bundle product and you will be done.', 'yith-woocommerce-product-bundles' ), '<strong>', '</strong>' ) ?>
		</p>
		...
		<p>
			<a class="cta" href="//yithemes.com/docs-plugins/yith-woocommerce-product-bundles/"><?php _e( 'View plugin documentation', 'yith-woocommerce-product-bundles' ) ?></a>
		</p>
	</div>
</div>