...
<table class="yith-wcpb-select-product-box__products__table widefat">
    ...
    <?php foreach ( $products as $product ):
        ...
        ?>
        <tr class="yith-wcpb-select-product-box__product" data-product-id="<?php echo $product->get_id() ?>">
            ...
            <td class="column-action">
                ...
                <span class="yith-wcpb-product-added">
					...
					<span class="yith-wcpb-product-added__text">
						<?php _e( 'Product added to the bundle', 'yith-woocommerce-product-bundles' ) ?>
					</span>
				</span>
            </td>
        </tr>
